...
(1, 'Ali', 'ali@example.com', '08123456789', 'Jalan Mawar No. 123'),
(2, 'Budi', 'budi@example.com', '08198765432', 'Jalan Melati No. 456');
...
(1, 'Laptop', 'Laptop gaming dengan RAM 8GB', 7500000.00, 10),
(2, 'Mouse', 'Mouse wireless', 200000.00, 50);
...
INSERT INTO `sales` (`sale_id`, `customer_id`, `sale_date`, `total`) VALUES
(1, 1, '2024-11-07 08:06:55', 7700000.00);
